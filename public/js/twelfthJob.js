...
document.getElementById('uploadButton').addEventListener('click', function() {
  fetch('/api/upload-twelfth-job-csv', {
    method: 'POST'
  })
...
async function fetchData() {
  try {
      const response = await fetch('/api/get-twelfth-job-data');
...
function fetchCountries() {
  return fetch('/api/get-countries-twelfth-job')
...
function fetchdecade() {
  return fetch('/api/get-decade-twelfth-job')
    .then(response => response.json())
    .then(decadeData => {
