...
document.getElementById('uploadButton').addEventListener('click', function() {
    fetch('/api/upload-fifteenth-job-csv', {
      method: 'POST'
    })
...
async function fetchData() {
    try {
        const response = await fetch('/api/get-fifteenth-job-data');
...
chart.selectAll(".bar")
  ...
  function fetchCountries() {
    return fetch('/api/get-countries-fifteenth-job')
...
function fetchdecade() {
    return fetch('/api/get-decade-fifteenth-job')
      .then(response => response.json())
      .then(decadeData => {
...
function fetchQuintile() {
    return fetch('/api/get-quintile-fifteenth-job')
      .then(response => response.json())
      .then(quintileData => {
